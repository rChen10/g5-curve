all: line pixel screen matrix polygon parser main bin
...
parser: include/parser.h include/polygon.h
	g++ -c src/parser.cpp -o build/parser.o

main: include/parser.h
	g++ -c src/main.cpp -o build/main.o

bin: build/pixel.o build/line.o build/screen.o build/matrix.o build/polygon.o build/parser.o build/main.o
